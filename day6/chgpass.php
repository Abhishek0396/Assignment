...
$queryget=mysqli_query($connect,"select password from studentlogin where clid='$user'")or die("Query doesn't exist");
$row=mysqli_fetch_assoc($queryget);
if($newpassword==$repeatpassword)
{
$querychange=mysqli_query($connect,"update studentlogin set password='$newpassword'where clid='$user'");
session_destroy();
