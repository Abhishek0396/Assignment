...
$namecheck=mysqli_query($connect,"select username from adminlogin where username='$username'");
...
$queryreg=mysqli_query($connect,"insert into adminlogin values('','$fullname','$username','$password','$repeatpassword','$clid')");
